(function () {
    ...
    e.modules = {}, e.aliases = {}, e.resolve = function (t) {
        ...
        var i = t("query"), o = Element.prototype,
        ...
        s.exports = n, n.prototype.bindEvents = function () {
            ...
            var e = {
                ...
                quantity: {type: "div", selector: "range-quantity"}
            };
            ...
            var s = l.from(parseFloat(e), t), n = l.of(s, this.options.max - this.options.min) + this.options.min,
                i = !1;
            ...
            var s = e - t, n = l.from(this.checkStep(this.options.step), this.options.max - this.options.min),
                o = l.of(n, s), r = [];
        ...
        s.exports = n, i(n, a), n.prototype.setStart = function (e) {
            var t = null === e ? this.options.min : e,
                s = r.from(t - this.options.min, this.options.max - this.options.min) || 0,
                n = r.of(s, this.slider.offsetWidth - this.handle.offsetWidth),
                i = this.options.step ? o.find(n, this.steps) : n;
            ...
            this.handle.style.left = e -12 + "px", this.slider.querySelector(".range-quantity").style.width = e + "px"
        ...
        s.exports = n, i(n, l), n.prototype.setStart = function (e) {
            var t = null === e ? this.options.min : e,
                s = a.from(t - this.options.min, this.options.max - this.options.min) || 0,
                n = a.of(s, this.slider.offsetHeight - this.handle.offsetHeight),
                i = this.options.step ? r.find(n, this.steps) : n;
